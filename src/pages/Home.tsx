...
const Home: React.FC = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin className="h-6 w-6" />, url: 'https://www.linkedin.com/in/misbah-ul-islam-0501b2323/', label: 'LinkedIn' },
    { icon: <Instagram className="h-6 w-6" />, url: 'https://www.instagram.com/aimers_foundation_coaching/', label: 'Instagram' },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8 relative">
        ...
        <div className="card mb-8">
          <div className="flex items-start space-x-4 mb-6">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2">Why Join Aimers Foundation?</h3>
