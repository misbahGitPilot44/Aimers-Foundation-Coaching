...
const Footer: React.FC = () => {
  ...
  const contactInfo = [
    { icon: <Mail className="h-4 w-4" />, text: 'aimersfoundationcoaching19@gmail.com' },
    { icon: <MapPin className="h-4 w-4" />, text: '108/19, Zakir Nagar, New Delhi, 110025' },
  ];

  const socialLinks = [
    { icon: <Linkedin className="h-5 w-5" />, url: 'https://www.linkedin.com/in/misbah-ul-islam-0501b2323/', label: 'LinkedIn' },
    { icon: <Instagram className="h-5 w-5" />, url: 'https://www.instagram.com/aimers_foundation_coaching/', label: 'Instagram' },
    { 
      ...
      url: ' https://discord.com/channels/1260999897960943727/@home', 
      label: 'Discord' 
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm text-gray-300 mb-6">
              Aimers Foundation Coaching is dedicated to empowering students through quality education, expert guidance, structured learning, and personalized mentorship for academic excellence.
            </p>
